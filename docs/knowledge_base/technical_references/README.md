...
| `command_system.md` | Exhaustive documentation of the command system: auto-discovery, execution handlers, WebSocket protocol, signature verification, and GUI command architecture (modal-based pattern with dual feedback mechanism) | 2025-10-16 |
...
| `dynamic_personalization_architecture.md` | Complete technical documentation of the Dynamic Personalization System: inheritance-and-override architecture, per-user configuration, prompt customization, dynamic LLM provider selection, and Genesis Template mechanism | 2025-10-11 |
