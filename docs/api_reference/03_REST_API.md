...
**Note**: In v2 architecture, `CORE_IDENTITY` and other context blocks are generated by `ContextBuilder`. Only `friends_profile` is stored in config for user personalization.
