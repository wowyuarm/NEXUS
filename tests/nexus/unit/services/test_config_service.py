...
class TestConfigService:
    ...
    @pytest.mark.asyncio
    async def test_initialize_loads_from_db_successfully(self, config_service, mock_database_service):
    ...
    @pytest.mark.asyncio
    async def test_initialize_falls_back_to_defaults_on_db_failure(self, config_service, mock_database_service, caplog):
    ...
    @pytest.mark.asyncio
    async def test_get_with_dot_notation_and_defaults(self, config_service, mock_database_service):
    ...
    @pytest.mark.asyncio
    async def test_get_int_conversion(self, config_service, mock_database_service, caplog):
    ...
    @pytest.mark.asyncio
    async def test_get_float_conversion(self, config_service, mock_database_service, caplog):
    ...
    @pytest.mark.asyncio
    async def test_environment_variable_substitution(self, config_service, mock_database_service, mocker):
        ...
        mock_database_service.get_configuration_async.return_value = config_with_env_vars
        await config_service.initialize('development')
        ...
        assert config_service.get('api.missing_var') == '${MISSING_VAR}'  # Unchanged if env var doesn't exist
        assert config_service.get('api.regular_value') == 'no_substitution'

    @pytest.mark.asyncio
    async def test_update_configuration_success(self, config_service, mock_database_service):
        ...
        mock_database_service.upsert_configuration_async.assert_called_once_with('development', new_config)

    @pytest.mark.asyncio
    async def test_update_configuration_failure(self, config_service, mock_database_service, caplog):
        ...
        # Mock failed update
        mock_database_service.upsert_configuration_async.side_effect = Exception("Database error")
        ...
        assert config_service.get('server.host') == 'localhost'  # Configuration unchanged
    ...
    @pytest.mark.asyncio
    async def test_get_all_returns_copy_of_config(self, config_service, mock_database_service):
