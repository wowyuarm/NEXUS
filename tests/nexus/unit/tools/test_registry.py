...
class TestToolRegistry:
    ...
    def test_register_invalid_tool_definition(self):
        ...
        with pytest.raises(ValueError, match="Invalid tool definition: missing function.name"):
    ...
    def test_register_tool_from_definition_missing_function(self, mocker):
        ...
        registry._register_tool_from_definition(mock_module, "test_module", "TEST_TOOL", tool_definition)
