...
class TestRoleEnum:
    ...
    def test_role_enum_values(self):
        ...
        for expected_role in expected_roles:
            assert expected_role in actual_roles, f"Role.{expected_role} not found in Role enum"
    ...
    def test_role_enum_string_inheritance(self):
        ...
        assert str(Role.HUMAN) == "Role.HUMAN"  # Enum __str__ returns the full representation
...
class TestRunStatusEnum:
    ...
    def test_run_status_enum_values(self):
        ...
        expected_statuses = [
            "PENDING", "BUILDING_CONTEXT", "AWAITING_LLM_DECISION",
            "AWAITING_TOOL_RESULT", "GENERATING_RESPONSE", "COMPLETED",
            "FAILED", "TIMED_OUT"
        ]
        ...
        for expected_status in expected_statuses:
            assert expected_status in actual_statuses, f"RunStatus.{expected_status} not found in RunStatus enum"
    ...
    def test_run_status_enum_string_inheritance(self):
        ...
        # Verify string operations work
        assert str(RunStatus.PENDING) == "RunStatus.PENDING"  # Enum __str__ returns the full representation
        assert RunStatus.PENDING.value == "PENDING"  # .value returns the actual string value
