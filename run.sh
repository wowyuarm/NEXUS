...
# Change to the script's real directory. This is the key.
cd "$SCRIPT_DIR" || { echo -e "${C_RED}Error: Could not change to the project root directory '$SCRIPT_DIR'${C_NC}"; exit 1; }
