"""
Moonshot AI LLM provider implementation for NEXUS.

This module implements the MoonshotLLMProvider class that provides access to
Kimi models via Moonshot AI's official OpenAI-compatible API.

Features:
- Direct access to Kimi models via official API
...
class MoonshotLLMProvider(LLMProvider):
    """Moonshot AI LLM provider using OpenAI-compatible API."""
    ...
    def __init__(
        ...
        """
        Initialize the Moonshot LLM provider.

        Args:
            api_key: Moonshot API key
            base_url: Base URL for the Moonshot API
        ...
        logger.info(
            f"MoonshotLLMProvider initialized with model={self.default_model}, "
    ...
    async def chat_completion(
        ...
        """
        Generate a chat completion using Moonshot AI.
        ...
        try:
            ...
            logger.error(f"Error in Moonshot chat completion: {e}")
            raise
